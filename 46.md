...
The client always starts by generating a random key which is used to communicate with the signer, then one of the methods below is used to allow the client to know what the signer public key is for the session and which relays to use.
